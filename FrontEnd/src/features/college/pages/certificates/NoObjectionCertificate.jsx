  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-slate-600">Issue a no objection certificate (NOC) for a student transferring or applying elsewhere.</p>
      </div>
      ...
      <div className="rounded-lg border border-slate-200 bg-white px-5 py-6">
        <p className="text-sm text-slate-500">
          ...
          by registration number and issue a printable no objection certificate from this page.
        </p>
      </div>
    </section>
  )
