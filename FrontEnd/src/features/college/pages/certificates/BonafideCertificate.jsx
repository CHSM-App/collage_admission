      ...
      <div className="rounded-xl border border-slate-200 bg-white">
        ...
        <div className="px-5 py-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
            ...
            />
            <label className="flex items-center gap-2 text-sm text-slate-700 h-10 px-1">
              <input
                type="checkbox"
                name="is_ex_student"
          ...
          <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
            ...
            <Button
              variant="secondary"
              onClick={handleEdit}
              disabled={!canEdit || mode !== 'view' || !form.bonafide_id}
            >
              Edit
            </Button>
            ...
            <Button variant="secondary" onClick={handlePrint} disabled={!form.bonafide_id}>
              Print
            </Button>
